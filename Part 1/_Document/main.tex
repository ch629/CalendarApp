...
\begin{enumerate}
  ...
  \begin{enumerate}[label=NF\arabic*.] %TODO: These need to be completed fully. More added?
      ...
      \item The product must be executable on all standard desktop Operating Systems with X minimum specifications. (AH) %TODO: Fill this in from Adam's github commit
...
\noindent\underline{\textit{Event Request:}} \\
...
\noindent\underline{\textit{Attendee:}} \\
...
\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{ERDiagram.png}} %TODO: Check this sizing at the end.
