...
\begin{figure}[!ht]
    \centering
    \makebox[0.75\textwidth]{\includegraphics[width=0.75\paperheight]{ProposedGanttChart.png}} 
...
\begin{figure}[!ht]
    \centering
    \makebox[0.75\textwidth]{\includegraphics[width=0.75\paperheight]{ActualGanttChart.png}} 
...
\begin{figure}[!ht]
    \centering
    \makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{OnionModel.png}} 
...
\begin{figure}[!ht]
    \centering
    \makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{ClassDiagram.jpg}} 
...
\begin{figure}[!ht] 
    \centering\makebox[0.9\textwidth]{\includegraphics[width=0.75\paperheight]{ERDiagram.png}} 
...
\begin{figure}[!ht] 
    \centering\makebox[0.9\textwidth]{\includegraphics[width=0.75\paperwidth]{ArchDiagram.png}} 
...
\begin{figure}[!ht] 
    \centering\makebox[0.9\textwidth]{\includegraphics[width=0.75\paperwidth]{MVCDiagram.png}} 
    \caption{MVC Diagram}
    \label{fig:mvc}
\end{figure}
...
\includepdf[pages={1}]{scenarios/AH.pdf}
\includepdf[pages={1}]{scenarios/CH.pdf}

\clearpage
\subsection{Screen Designs}
\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/LoginCI.png}} 
    \caption{Login - CI}
    \label{fig:login}
\end{figure}

\begin{figure}[!ht] 
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/CH1.png}} 
    \caption{Create Group 1 - CH}
    \label{fig:create_group1}
\end{figure}

\begin{figure}[!ht] 
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/CH2.png}} 
    \caption{Create Group 2 - CH}
    \label{fig:create_group2}
\end{figure}

\begin{figure}[!ht] 
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/CH3.png}} 
    \caption{Create Group 3 - CH}
    \label{fig:create_group3}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/CreateEventCalendarLA.png}}
    \caption{Create Event - LA}
    \label{fig:create_event_cal}     
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/CreateEventLA.png}} 
    \caption{Create Event - LA}
    \label{fig:create_event}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA1.png}} 
    \caption{Edit Event 1 - BA}
    \label{fig:edit_event1}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA2.png}} 
    \caption{Edit Event 2 - BA}
    \label{fig:edit_event2}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA3.png}} 
    \caption{Edit Event 3 - BA}
    \label{fig:edit_event3}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA4.png}} 
    \caption{Edit Event 4 - BA}
    \label{fig:edit_event4}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/AH1.jpg}} 
    \caption{Admin View 1 - AH}
    \label{fig:admin1}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/AH2.jpg}} 
    \caption{Admin View 2 - AH}
    \label{fig:admin2}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/AH3.jpg}} 
    \caption{Admin View 3 - AH}
    \label{fig:admin3}
\end{figure}
