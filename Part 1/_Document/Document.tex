...
\begin{figure}[!ht] 
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/CH1.png}} %TODO: Check this sizing at the end.
    \caption{Create Group 1 - CH}
    \label{fig:create_group1}
\end{figure}

\begin{figure}[!ht] 
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/CH2.png}} %TODO: Check this sizing at the end.
    \caption{Create Group 2 - CH}
    \label{fig:create_group2}
\end{figure}

\begin{figure}[!ht] 
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.6\paperwidth]{screens/CH3.png}} %TODO: Check this sizing at the end.
    \caption{Create Group 3 - CH}
    \label{fig:create_group3}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/CreateEventCalendarLA.png}} %TODO: Check this sizing at the end.
    \caption{Create Event - LA}
    \label{fig:create_event_cal}     
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/CreateEventLA.png}} %TODO: Check this sizing at the end.
    \caption{Create Event - LA}
    \label{fig:create_event}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA1.png}} %TODO: Check this sizing at the end.
    \caption{Edit Event 1 - BA}
    \label{fig:edit_event1}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA2.png}} %TODO: Check this sizing at the end.
    \caption{Edit Event 2 - BA}
    \label{fig:edit_event2}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA3.png}} %TODO: Check this sizing at the end.
    \caption{Edit Event 3 - BA}
    \label{fig:edit_event3}
\end{figure}

\begin{figure}[!ht]
    \centering\makebox[0.75\textwidth]{\includegraphics[width=0.75\paperwidth]{screens/BA4.png}} %TODO: Check this sizing at the end.
