...
public class EventOnDayRequest extends Request<SingleDataResponse<List<NewEvent>>> {
    ...
    public EventOnDayRequest(char[] authToken, SingleDataResponse<List<NewEvent>> expectedResponse, int day, int month, int year) {
